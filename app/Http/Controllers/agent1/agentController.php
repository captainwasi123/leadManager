...
class agentController extends Controller
{
    ...
    function index(){
        ...
        $data['total_pending_leads'] = leads::where('created_by', Auth::id())->where('status', 1)->count();
        $data['total_marked_leads'] = leads::where('created_by', Auth::id())->where('status', 2)->count();
